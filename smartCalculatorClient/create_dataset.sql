...
--
-- Host: localhost    Database: wangyang
-- ------------------------------------------------------
...
CREATE DATABASE wangyang default character set utf8;
USE wangyang;
--
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`vegetable_id`) REFERENCES `vegetable` (`id`)
...
INSERT INTO `vegetable` VALUES (1,'青辣椒',2.3),(2,'黄瓜',4.5);
...
-- Dump completed on 2019-01-13 12:07:30
